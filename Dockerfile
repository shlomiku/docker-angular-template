...
#RUN npm install --unsafe-perm -gq ionic@3.0.0-rc.1 cordova@6.5.0
RUN npm install --unsafe-perm -gq @angular/cli@latest
...
#RUN npm install karma phantomjs-prebuilt karma-phantomjs-launcher
